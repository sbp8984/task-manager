...
const deprecateOptions = require('mongodb/lib/utils').deprecateOptions;
const checkCollectionName = require('mongodb/lib/utils').checkCollectionName;
const ObjectID = require('mongodb-core').BSON.ObjectID;
const AggregationCursor = require('mongodb/lib/aggregation_cursor');
const MongoError = require('mongodb-core').MongoError;
const toError = require('mongodb/lib/utils').toError;
const normalizeHintField = require('mongodb/lib/utils').normalizeHintField;
const handleCallback = require('mongodb/lib/utils').handleCallback;
const decorateCommand = require('mongodb/lib/utils').decorateCommand;
const decorateWithCollation = require('mongodb/lib/utils').decorateWithCollation;
const decorateWithReadConcern = require('mongodb/lib/utils').decorateWithReadConcern;
const formattedOrderClause = require('mongodb/lib/utils').formattedOrderClause;
const ReadPreference = require('mongodb-core').ReadPreference;
const CommandCursor = require('mongodb/lib/command_cursor');
const unordered = require('mongodb/lib/bulk/unordered');
const ordered = require('mongodb/lib/bulk/ordered');
const ChangeStream = require('mongodb/lib/change_stream');
const executeOperation = require('mongodb/lib/utils').executeOperation;
const applyWriteConcern = require('mongodb/lib/utils').applyWriteConcern;
const resolveReadPreference = require('mongodb/lib/utils').resolveReadPreference;

// Operations
const bulkWrite = require('mongodb/lib/operations/collection_ops').bulkWrite;
const checkForAtomicOperators = require('mongodb/lib/operations/collection_ops').checkForAtomicOperators;
const count = require('mongodb/lib/operations/collection_ops').count;
const countDocuments = require('mongodb/lib/operations/collection_ops').countDocuments;
const createIndex = require('mongodb/lib/operations/collection_ops').createIndex;
const createIndexes = require('mongodb/lib/operations/collection_ops').createIndexes;
const deleteMany = require('mongodb/lib/operations/collection_ops').deleteMany;
const deleteOne = require('mongodb/lib/operations/collection_ops').deleteOne;
const distinct = require('mongodb/lib/operations/collection_ops').distinct;
const dropIndex = require('mongodb/lib/operations/collection_ops').dropIndex;
const dropIndexes = require('mongodb/lib/operations/collection_ops').dropIndexes;
const ensureIndex = require('mongodb/lib/operations/collection_ops').ensureIndex;
const findAndModify = require('mongodb/lib/operations/collection_ops').findAndModify;
const findAndRemove = require('mongodb/lib/operations/collection_ops').findAndRemove;
const findOne = require('mongodb/lib/operations/collection_ops').findOne;
const findOneAndDelete = require('mongodb/lib/operations/collection_ops').findOneAndDelete;
const findOneAndReplace = require('mongodb/lib/operations/collection_ops').findOneAndReplace;
const findOneAndUpdate = require('mongodb/lib/operations/collection_ops').findOneAndUpdate;
const geoHaystackSearch = require('mongodb/lib/operations/collection_ops').geoHaystackSearch;
const group = require('mongodb/lib/operations/collection_ops').group;
const indexes = require('mongodb/lib/operations/collection_ops').indexes;
const indexExists = require('mongodb/lib/operations/collection_ops').indexExists;
const indexInformation = require('mongodb/lib/operations/collection_ops').indexInformation;
const insertOne = require('mongodb/lib/operations/collection_ops').insertOne;
const isCapped = require('mongodb/lib/operations/collection_ops').isCapped;
const mapReduce = require('mongodb/lib/operations/collection_ops').mapReduce;
const optionsOp = require('mongodb/lib/operations/collection_ops').optionsOp;
const parallelCollectionScan = require('mongodb/lib/operations/collection_ops').parallelCollectionScan;
const prepareDocs = require('mongodb/lib/operations/collection_ops').prepareDocs;
const reIndex = require('mongodb/lib/operations/collection_ops').reIndex;
const removeDocuments = require('mongodb/lib/operations/collection_ops').removeDocuments;
const rename = require('mongodb/lib/operations/collection_ops').rename;
const replaceOne = require('mongodb/lib/operations/collection_ops').replaceOne;
const save = require('mongodb/lib/operations/collection_ops').save;
const stats = require('mongodb/lib/operations/collection_ops').stats;
const updateDocuments = require('mongodb/lib/operations/collection_ops').updateDocuments;
const updateMany = require('mongodb/lib/operations/collection_ops').updateMany;
const updateOne = require('mongodb/lib/operations/collection_ops').updateOne;
