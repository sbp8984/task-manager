...
const count = require('mongodb/lib/operations/cursor_ops').count;
const each = require('mongodb/lib/operations/cursor_ops').each;
const hasNext = require('mongodb/lib/operations/cursor_ops').hasNext;
const next = require('mongodb/lib/operations/cursor_ops').next;
const toArray = require('mongodb/lib/operations/cursor_ops').toArray;
