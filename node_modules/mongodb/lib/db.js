...
const getSingleProperty = require('mongodb/lib/utils').getSingleProperty;
const CommandCursor = require('mongodb/lib/command_cursor');
const handleCallback = require('mongodb/lib/utils').handleCallback;
const filterOptions = require('mongodb/lib/utils').filterOptions;
...
const mergeOptionsAndWriteConcern = require('mongodb/lib/utils').mergeOptionsAndWriteConcern;
...
// Operations
const addUser = require('mongodb/lib/operations/db_ops').addUser;
const collections = require('mongodb/lib/operations/db_ops').collections;
const createCollection = require('mongodb/lib/operations/db_ops').createCollection;
const createIndex = require('mongodb/lib/operations/db_ops').createIndex;
const createListener = require('mongodb/lib/operations/db_ops').createListener;
const dropCollection = require('mongodb/lib/operations/db_ops').dropCollection;
const dropDatabase = require('mongodb/lib/operations/db_ops').dropDatabase;
const ensureIndex = require('mongodb/lib/operations/db_ops').ensureIndex;
const evaluate = require('mongodb/lib/operations/db_ops').evaluate;
const executeCommand = require('mongodb/lib/operations/db_ops').executeCommand;
const executeDbAdminCommand = require('mongodb/lib/operations/db_ops').executeDbAdminCommand;
const indexInformation = require('mongodb/lib/operations/db_ops').indexInformation;
const listCollectionsTransforms = require('mongodb/lib/operations/db_ops').listCollectionsTransforms;
const profilingInfo = require('mongodb/lib/operations/db_ops').profilingInfo;
const profilingLevel = require('mongodb/lib/operations/db_ops').profilingLevel;
const removeUser = require('mongodb/lib/operations/db_ops').removeUser;
const setProfilingLevel = require('mongodb/lib/operations/db_ops').setProfilingLevel;
const validateDatabaseName = require('mongodb/lib/operations/db_ops').validateDatabaseName;
