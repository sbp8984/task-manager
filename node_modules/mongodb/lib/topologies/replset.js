...
const TopologyBase = require('mongodb/lib/topologies/topology_base').TopologyBase;
const Store = require('mongodb/lib/topologies/topology_base').Store;
const CReplSet = require('mongodb-core').ReplSet;
const MAX_JS_INT = require('mongodb/lib/utils').MAX_JS_INT;
const translateOptions = require('mongodb/lib/utils').translateOptions;
const filterOptions = require('mongodb/lib/utils').filterOptions;
const mergeOptions = require('mongodb/lib/utils').mergeOptions;
